...
model_file = './2021-10-11 19:44:43'
...
preds_list = [12,48,62,78]
pred_plot_ensemble(Data, Data.valid[0], Data.valid[1], model, evaluateL2, evaluateL1, args.batch_size, figs_fold,logs_file,preds_list, skip = skip)